...
% ============================================================================
% Proof and Countermodel: An Introduction to Logic with Lean
...
\title{\texorpdfstring{\textbf{Proof and Countermodel}\\[0.3em]
  \large An Introduction to Logic with Lean}%
  {Proof and Countermodel: An Introduction to Logic with Lean}}
...
\part{Foundations}
\include{chapters/ch01-propositions}
\include{chapters/ch02-natural-deduction}
\include{chapters/ch03-classical-constructive}
\include{chapters/ch04-quantifiers}

\part{Structure}
\include{chapters/ch05-relations-orders}
\include{chapters/ch06-set-theory}
